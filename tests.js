...
const testCases = [
  ...
  new TestCase('?action=getbbox&lehti=S4311R&projection=EPSG:4326', '[25.198948170054766,65.29022768006281,25.449792073038758,65.40071166582779]', 'should return correct bbox in EPSG:4326'),
...
test('starting external tests', t => {
